...
"[project]/src/app/api/projects/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
      ...
      `).eq('slug', slug).eq('is_active', true).single();
        ...
        const { data: similarProjects } = await supabase.from('projects').select(`
        id,
        name,
        slug,
        price_from,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__279383e7._.js.map