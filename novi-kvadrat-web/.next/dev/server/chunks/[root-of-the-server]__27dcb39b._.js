...
"[project]/src/app/api/cities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: cities, error } = await supabase.from('cities').select('id, name_en, name_sr_lat, name_sr_cyr, slug, country').eq('country', country).eq('is_active', true).order('sort_order', {
            ascending: true
        });
        if (error) {
            throw error;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27dcb39b._.js.map