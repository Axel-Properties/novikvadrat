...
interface EditLayoutPageClientProps {
  projectId: string
  layoutId: string
  locale: string
...
export function EditLayoutPageClient({
  projectId,
  layoutId,
  locale,
  initialProjectName,
  initialLayout,
}: EditLayoutPageClientProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    layout_type: initialLayout.layout_type,
    total_area: initialLayout.total_area?.toString() || '',
    living_area: initialLayout.living_area?.toString() || '',
    terrace_area: initialLayout.terrace_area?.toString() || '',
    bedrooms: initialLayout.bedrooms?.toString() || '',
    bathrooms: initialLayout.bathrooms?.toString() || '',
    has_terrace: initialLayout.has_terrace,
    has_loggia: initialLayout.has_loggia,
    price_from: initialLayout.price_from?.toString() || '',
    price_to: initialLayout.price_to?.toString() || '',
    floor_plan_url: initialLayout.floor_plan_url || '',
    total_units: initialLayout.total_units?.toString() || '',
    available_units: initialLayout.available_units?.toString() || ''
  })
